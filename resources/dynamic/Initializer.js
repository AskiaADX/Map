...
(function () {
    var map = new Map({
        ...
        mapPaths : [
        {%:= CurrentADC.GetContent("dynamic/" + pathFileName + ".txt").ToText() %}
        ]
    });
} ());
